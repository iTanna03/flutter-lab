...
class RadialMenuAnchorWrapper {
  ...
  static final _anchorToAngle = {
    ...
    RadialMenuAnchor.centerRight: RadialAngle(
        ...
        orientation: RadialSweepOrientation.vertical),
    RadialMenuAnchor.bottomLeft:
        RadialAngle(startAngle: _threeQuarterPi, endAngle: _full),
    RadialMenuAnchor.bottomCenter: RadialAngle(
        startAngle: _pi,
        endAngle: _full,
        orientation: RadialSweepOrientation.horizontal),
    RadialMenuAnchor.bottomRight:
        RadialAngle(startAngle: _pi, endAngle: _threeQuarterPi)
  };
...
class RadialAngle {
  RadialAngle(
      {required this.startAngle, required this.endAngle, this.orientation});
